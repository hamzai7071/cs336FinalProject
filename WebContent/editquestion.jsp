<%-- 
    ...
    Created on : Apr 28, 2020, 7:41:44 PM
    Author     : silen
--%>
            ...
            <div class="row">
                ...
                <div class="col-md-8">
                    ...
                    <div class="card card-primary">
                        ...
                        <!-- /.card-header -->
                        <!-- form start -->
                        <form role="form" action="editaquestion" method="post">
                            <div class="card-body">
                                <div class="form-group">
                                    <label>Question</label>
                                    <textarea  name="question" class="form-control"  min="5" rows="3" placeholder=" ..."> <%=dto.getQuestion()%></textarea>
                                </div>
                                <div class="form-group">
                                    <label>Answer</label>
                                    <textarea name="answer" class="form-control"  min="5" rows="3" placeholder="Answer ..."> <%=dto.getAnswer()%></textarea>
                                </div>
