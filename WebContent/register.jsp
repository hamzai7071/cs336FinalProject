<%-- 
    Document   : register
    Created on : Apr 26, 2020, 12:31:12 PM
    Author     : silen
--%>
<% //Session
...
<html>
    <head>
        ...
        <title>Metro Express | Registration Page</title>
    ...
    <body class="hold-transition register-page">
        <div class="register-box">
            <div class="register-logo">
                <a href="home.jsp"><b>Metro</b>Expree</a>
            </div>
                ...
                <div class="card-body register-card-body">
                    ...
                    <form action="register" method="post">
                        <div class="input-group mb-3">
                            <input type="text" class="form-control" required="" name="fname" placeholder="Fisrt name" >
                    ...
                    <a href="login.jsp" class="text-center">I already have a account</a>
                </div>
                <!-- /.form-box -->
            </div><!-- /.card -->
        </div>
