                        ...
                        <!-- form start -->
                            ...
                            <div class="card-body">
                                <div class="form-group">
                                    ...
                                    <textarea  class="form-control" disabled="" min="5" rows="3" placeholder=""> <%=dto.getQuestion() %></textarea>
                                </div>
                                <div class="form-group">
                                    <label>Answer</label>
                                    <textarea class="form-control"  min="5" rows="3" disabled="" placeholder=""> <%=dto.getAnswer() %></textarea>
                                </div>
